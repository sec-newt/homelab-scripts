...
Reference skills for Claude Code and OpenClaw — security-focused tools for homelab and CTF work.
...
```bash
for skill in docker-compose-helper log-analyzer nmap-interpreter pcap-analyzer; do
